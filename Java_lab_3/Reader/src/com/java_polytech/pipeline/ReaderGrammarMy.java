...
// The class implementing a grammar interface for a reader
public class ReaderGrammarMy implements MyIGrammar {
    // The enum containing the reader's grammar fields
